...
public final class providerAddEvent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(prov.getSubscription().getTime() < Calendar.getInstance().getTime().getTime()){
      ...
      out.write("                                      </div>\n");
      out.write("                                      <div class=\"form-group\">\n");
      out.write("                                        <input type=\"hidden\" name=\"lat\" id=\"lat\" class=\"form-control\" placeholder=\"Γεωγραφικό πλάτος\" value=\"\" required=\"required\" disabled>\n");
      out.write("                                      </div>\n");
      out.write("                                      <div class=\"form-group\">\n");
      out.write("                                        <input type=\"hidden\" name=\"lng\" id=\"lng\" class=\"form-control\" placeholder=\"Γεωγραφικό μήκος\" value=\"\" required=\"required\" disabled>\n");
      out.write("                                      </div>\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input placeholder=\"Αριθμός Εισιτηρίων\" type=\"number\" min=\"0\" class=\"form-control\" name=\"\" value=\"\" required=\"required\">\n");
      out.write("\t\t\t\t\t\t\t\t\t  </div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input placeholder=\"Τιμή\" type=\"number\" min=\"0\"  class=\"form-control\" name=\"\" value=\"\" required=\"required\">\n");
      out.write("\t\t\t\t\t\t\t\t\t  </div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea name=\"name\" style=\"resize:none; font-size: 16px;\" rows=\"3\" class=\"form-control\" placeholder=\"Περιγραφή\" required=\"required\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t\t  </div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input placeholder=\"Tags\" type=\"text\" class=\"form-control\" name=\"\" value=\"\" required=\"required\">\n");
      out.write("\t\t\t\t\t\t\t\t\t  </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
