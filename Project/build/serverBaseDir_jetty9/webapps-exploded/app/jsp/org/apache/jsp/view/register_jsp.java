...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (session.getAttribute("client") == null){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"lat\" id=\"lat\" class=\"form-control\" placeholder=\"Γεωγραφικό πλάτος\" value=\"\" required=\"required\" hidden>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"lng\" id=\"lng\" class=\"form-control\" placeholder=\"Γεωγραφικό μήκος\" value=\"\" required=\"required\" hidden>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"tel\" pattern=\"^\\d{10}$\" name=\"phone\" id=\"tel\" tabindex=\"1\" class=\"form-control\" placeholder=\"Τηλέφωνο\" value=\"\" required=\"required\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
